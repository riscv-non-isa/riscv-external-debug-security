...
[[dbgdisallowed]]
* Halt request (haltreq), single step into disallowed privilege or halt group that causes the hart to enter debug mode will be pending until debug is allowed again
