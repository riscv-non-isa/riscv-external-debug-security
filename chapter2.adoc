...
EBREAK works normal as specified in debug spec when external debug is allowed at running privilege level, when running in a debug disallowed privilege level, EBREAK will result in breakpoint exception
