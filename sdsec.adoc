...
* **M-mode Control**: Mandatory control for M-mode external debug and trace
...
| Sdsec (baseline)   | mdbgen           | mtrcen           | None          | M-mode
...
| M/S/U           | • Sdsec only +
                    • Sdsec + Smsdedbg +
                    • Sdsec + Smsdedbg + Smudedbg                     
| M/S/VS/VU/U     | • Sdsec only +
                    • Sdsec + Smsdedbg +
                    • Sdsec + Smsdedbg + Smvsdedbg +
                    • Sdsec + Smsdedbg + Smvsdedbg + Smudedbg                 
|=====================================================================
...
When `mdbgen` is set to 0 and the hart is running in M-mode:
...
- EBREAK always raises a breakpoint exception.
